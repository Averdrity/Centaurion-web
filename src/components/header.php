...
<header class="bg-light-card dark:bg-dark-card shadow-lg transition-colors duration-200">
  <nav class="container mx-auto px-4 py-4">
    <div class="flex justify-center items-center relative">

      <!-- Left: AI Chat + Soon -->
      <div class="absolute left-[80px] flex items-center gap-2">
        <a href="/chat.php" class="nav-button">
          <span class="icon" style="background-image: url('/assets/icons/tabler/message-circle.svg')"></span>
          <span>AI Chat</span>
        </a>
